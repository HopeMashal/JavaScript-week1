...
console.log(`It will need ${nb_year(1000, 2, 50, 1200)} entire years`);
console.log(`It will need ${nb_year(1500, 5, 100, 5000)} entire years`);
console.log(`It will need ${nb_year(1500000, 2.5, 10000, 2000000)} entire years`);